...
BEGIN
    ...
    BEGIN
        ...
        IF @RENDA_MENSAL IS NOT NULL AND @TELEFONE IS NOT NULL AND @STATUS = 'EM CADASTRO'
        BEGIN
       ...
       IF @STATUS = 'APROVADA'
        BEGIN
            ...
            END
            ELSE
                RAISERROR('CLIENTE JÁ EXISTENTE',16,1)
        end
...
INSERT INTO TB_SOLICITACAO_ABERTURA_CONTA(NOME, CPF, EMAIL, RENDA_MENSAL, TELEFONE)
VALUES ('TONi',10020024525,'TONHO@GMAIL.COM',2000,'999220877')
